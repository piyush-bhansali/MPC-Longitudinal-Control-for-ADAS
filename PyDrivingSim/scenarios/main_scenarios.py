...
class BasicTrafficLight():
    def __init__(self):
        ...
        trafficlight.set_pos((120,-3))
        trafficlight.set_time_phases((10, 3, 15))
        trafficlight.reset()

        trafficlight2 = TrafficLight()
        trafficlight2.set_pos((260,-3))
        trafficlight2.set_time_phases((8, 3, 20))
        trafficlight2.reset()

        trafficlight3 = TrafficLight()
        trafficlight3.set_pos((400,-3))
        trafficlight3.set_time_phases((12, 3, 18))
        trafficlight3.reset()
